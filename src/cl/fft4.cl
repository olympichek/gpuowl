...
#if !TEST_SHL
  Z61 x0 = A(0).x + A(2).x;             // Max value is 2*M61+epsilon
  Z61 x2 = A(0).x + neg(A(2).x, 2);     // Max value is 3*M61+epsilon
  Z61 y0 = A(0).y + A(2).y;
  Z61 y2 = A(0).y + neg(A(2).y, 2);

  Z61 x1 = A(1).x + A(3).x;
  Z61 y3 = A(1).x + neg(A(3).x, 2);
  Z61 y1 = A(1).y + A(3).y;
  Z61 x3 = A(3).y + neg(A(1).y, 2);
